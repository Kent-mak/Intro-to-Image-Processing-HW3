...
class LOAFEvaluator:
    ...
    def evaluate(
        ...
        for cur_iter, (imgs, _, info_imgs, ids) in enumerate(
            ...
            with torch.no_grad():
                # init tracker
                img_file_name = info_imgs[2][0]  # string like "0059_00015.jpg"
                video_id = img_file_name.split("_")[0]
                frame_id = int(img_file_name.split("_")[1].split(".")[0])

                if current_video_id is None:
                    current_video_id = video_id
                elif video_id != current_video_id:
                    result_filename = os.path.join(result_folder, f"{current_video_id}.txt")
            ...
            if cur_iter == len(self.dataloader) - 1:
                result_filename = os.path.join(result_folder, '{}.txt'.format(current_video_id))
                write_results(result_filename, results)
